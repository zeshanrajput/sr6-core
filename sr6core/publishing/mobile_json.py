...
def export_mobile_json(char_data: Dict[str, Any], char_repo_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _compile_vehicle_item(item: Dict[str, Any], is_drone: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            "hardware_sensor": aug_profile.get("hardware_sensor", sen),
            "enlightened_sensor": aug_profile.get("enlightened_sensor", aug_profile.get("augmented_sensor", sen)),
            "sensor_str": aug_profile.get("sensor_str", str(aug_profile.get("augmented_sensor", sen))),
            "seats": seats,
            "modifications": mods,
