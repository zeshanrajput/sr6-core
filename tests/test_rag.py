...
class TestRAGChatSession(unittest.TestCase):
    ...
    def test_client_reused_across_multiple_queries(self, mock_genai_client, mock_getenv, mock_load_env):
        ...
        session = RAGChatSession(effort_level=None)
        ...
        self.assertEqual(mock_genai_client.call_count, 1)
